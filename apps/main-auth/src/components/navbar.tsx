        ...
        >
          <ul className="navbar-nav gap-3 fs-5 fw-medium">
            <li className="nav-item">
              <a className="nav-link text-white" href="/secured/home">Home</a>
            </li>
            <li className="nav-item">
              <a className="nav-link text-white" href="/secured//mysql_editor">SQL</a>
            </li>
            <li className="nav-item">
              <a className="nav-link text-white" href="/secured//tic_tac_toe">Tic Tac Toe</a>
            </li>
          </ul>
